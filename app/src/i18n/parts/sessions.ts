...
export const sessions = {
  ...
  sessionStartingBody: 'A few seconds. If the folder trust screen shows, accept it on the Mac or in Term with the arrow keys and Enter.',
  sessionStartingWait: 'Claude is still starting, send again in a moment',
  sessionNoAgentTitle: 'No Claude in this pane',
  sessionNoAgentBody: 'This pane is a plain shell. Start a new Claude session here to chat with it from your phone, or open the terminal.',
  sessionNoAgentResumeBody: 'A Claude session was open here before Kova restarted. Resume it, start a new one, or open the terminal.',
  sessionStartClaude: 'Start new session',
  sessionResume: 'Resume',
  sessionStartClaudeFailed: (reason: string) => `Could not start Claude: ${reason}`,
  sessionResumeFailed: (reason: string) => `Could not resume the session: ${reason}`,
  terminalInputPlaceholder: 'Type a command, sent with Enter',
  terminalInputOffline: 'Terminal input needs the Mac',
  terminalInputA11y: 'Terminal input',
  terminalSendA11y: 'Send to the terminal with Enter',
  terminalKeyEsc: 'Esc',
  terminalKeyTab: 'Tab',
  terminalKeyCtrlC: 'Ctrl-C',
  terminalKeyEscA11y: 'Escape key',
  terminalKeyTabA11y: 'Tab key',
  terminalKeyCtrlCA11y: 'Control C',
  terminalKeyUpA11y: 'Up arrow',
  terminalKeyDownA11y: 'Down arrow',
